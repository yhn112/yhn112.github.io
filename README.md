...
Lighthouse snapshots for `https://diskin.me/` are stored in [`lighthouse_results/`](lighthouse_results/) and can be refreshed by manually running the `Lighthouse Badger` workflow.

### Desktop

[![Google Lighthouse PageSpeed Insights](lighthouse_results/desktop/pagespeed.svg)](lighthouse_results/desktop/)

Run the test yourself: [Google Lighthouse PageSpeed Insights](https://pagespeed.web.dev/report?url=https%3A%2F%2Fdiskin.me%2F&form_factor=desktop)

### Mobile

[![Google Lighthouse PageSpeed Insights](lighthouse_results/mobile/pagespeed.svg)](lighthouse_results/mobile/)

Run the test yourself: [Google Lighthouse PageSpeed Insights](https://pagespeed.web.dev/report?url=https%3A%2F%2Fdiskin.me%2F&form_factor=mobile)
