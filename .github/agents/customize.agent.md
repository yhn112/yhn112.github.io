...
3. **INSTALL.md** – Installation, deployment, and local setup instructions
...
- **Build process and requirements** – Local Ruby/Python setup, dependency management
...
1. **Run locally with Ruby/Bundler**:
...
- 🚫 **Never do:**
  ...
  - Change build dependencies without understanding their impact
...
| Test changes locally    | Ruby/Bundler local setup                                            | INSTALL.md § Local setup           |
